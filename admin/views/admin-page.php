    ...
    <div class="mcl-content">
        <div class="mcl-info">
            ...
            <p class="mcl-description">
                <?php esc_html_e( 'You can have up to 10 active checklists at once. Use keyboard shortcuts to quickly access them from anywhere on your site.', 'magic-checklists' ); ?>
            </p>
    </div>
